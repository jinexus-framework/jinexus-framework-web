...
final class ChangelogControllerTest extends TestCase
{
    ...
    private function createController(): ChangelogController
    {
        $routes = [
     ...
     */
    #[Test]
    public function index_action_view_model_has_title(): void
    {
        $controller = $this->createController();
        $variables = $controller->indexAction()->getVariables();

        self::assertArrayHasKey('title', $variables);
        self::assertSame('Changelog - JiNexus Framework', $variables['title']);
    }
    ...
    public function index_action_view_model_has_og_url(): void
    {
        ...
        self::assertStringContainsString('/changelog', $variables['meta']['og']['url']);
    }
}
